...
from torch.nn.modules import dropout, module
...
class Decoder(nn.Module):
    ...
    def forward(self, x, hidden, cell):
        ...
        outputs, _ = self.rnn(embedding, (hidden, cell))    
...
train_iterator, valid__iterator, test__iterator = BucketIterator.splits(
